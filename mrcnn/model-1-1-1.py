...
def focal_loss(target,rpn_class_logits,CE_loss,alpha=0.25, gamma=2):
...
def rpn_class_loss_graph(rpn_match, rpn_class_logits):
    ...
    #uncomment below lines to implement Focal Loss(sparse categorical focal loss)
...
def mrcnn_class_loss_graph(target_class_ids, pred_class_logits,
    ...
    #uncomment below lines to implement Focal Loss(sparse categorical focal loss)
    #loss = focal_loss(target_class_ids,pred_class_logits,CEloss)
